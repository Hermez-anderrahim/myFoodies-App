...
export const Home = ({restaurant, setrestaurant }) => {
  ...
  return (
    <div className='home'>
      ...
      <div className='hero'>
        <div className='Hero-text animate__animated animate__fadeInDown'>Find the best 
        ...
        <button className='getStarted'>
            <div className='innerText' onClick={scrool}>Get started</div>
        </button>
