  ...
  return (
    <div className='Details'>
      <div className='more-info'>
          <div className='res-image'><img src={`${ResData.photo ? ResData.photo.images.large.url : ""}`}/></div>
          <div className='description'>
            
            <div className='first-line'>
             <div className='res-name'>{ResData.name}</div>
             <div className='rating'><div className='rating-number2'>{ResData.rating}</div><div className='rating-star2'><svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 49 38" fill="none">
             ...
             <div className='delivery'>open:{ResData.is_closed ? "No" : "Yes"}</div>
             <div className='delivery'>location : {ResData.address_obj.country}</div>
             
              <button className='like' onClick={()=> handelLikeCick(id) }>{ResData.liked ? 
