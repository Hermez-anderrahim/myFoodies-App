...
import "./Cards.css";
export const Cards = ({ handelLikeCick }) => {
  const data = [
    {
      id: "1",
      ...
      <div className="info">
        <div className="container">
          ...
          <div className="open-like">
            ...
            <div className="like" onClick={() => handelLikeCick(data.id)}>
              {data.liked ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
